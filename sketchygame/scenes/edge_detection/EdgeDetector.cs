...
public static class EdgeDetector
{
    ...
    public static Texture2D ApplyEdgeDetection(Texture2D inputTexture)
    {
        ...
        Image gdImage = inputTexture.GetImage();
        ...
        ColorConversionCodes colorConversionCode = (gdImage.GetFormat() == Image.Format.Rgba8) ? ColorConversionCodes.RGBA2GRAY : ColorConversionCodes.RGB2GRAY;
        ...
        Cv2.GaussianBlur(grayMat, blurredMat, new OpenCvSharp.Size(GaussianBlurSize, GaussianBlurSize), 0, 0, BorderTypes.Constant);
